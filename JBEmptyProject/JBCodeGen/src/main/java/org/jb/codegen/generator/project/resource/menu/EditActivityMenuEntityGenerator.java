...
public class EditActivityMenuEntityGenerator extends EntityGenerator {

	public EditActivityMenuEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
	...
	public void source() {
		...
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassMenuActionResourceName(c, Operation.EDIT, dictionary, MenuAction.SAVE) + "\"\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.menu", activityResourceName.getClassMenuResourceName(c, Operation.EDIT, dictionary) + ".xml", element);
