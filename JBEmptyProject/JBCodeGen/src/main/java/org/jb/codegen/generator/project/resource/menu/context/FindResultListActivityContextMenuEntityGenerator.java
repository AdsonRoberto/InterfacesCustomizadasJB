...
public class FindResultListActivityContextMenuEntityGenerator extends EntityGenerator {

	public FindResultListActivityContextMenuEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
	...
	public void source() {
		...
		str.append("	tools:context=\"app.jb.generated." + activityResourceName.getClassName(c, Operation.FIND_RESULT_LIST, dictionary) + "\">\n");
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassContextMenuActionResourceName(c, Operation.FIND_RESULT_LIST, dictionary, MenuAction.DETAIL) + "\"\n");
		...
		str.append("		/>\n");
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassContextMenuActionResourceName(c, Operation.FIND_RESULT_LIST, dictionary, MenuAction.EDIT) + "\"\n");
		str.append("			android:orderInCategory=\"100\"\n");
		str.append("			android:title=\"@string/" + activityResourceName.getClassContextMenuActionStringResourceName(MenuAction.EDIT) + "\"\n");
		str.append("		/>\n");
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassContextMenuActionResourceName(c, Operation.FIND_RESULT_LIST, dictionary, MenuAction.DELETE) + "\"\n");
		str.append("			android:orderInCategory=\"100\"\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.menu", activityResourceName.getClassContextMenuResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + ".xml", element);
