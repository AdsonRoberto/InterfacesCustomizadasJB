...
public class XMLCodeGenMappingReader extends XMLMappingReader {
    public XMLCodeGenMappingReader(DescriptionDictionary dictionary) {
        super(dictionary);
        configuration = dictionary.getProjectConfiguration().getCodeGenConfiguration();
        directory = "codegen";
    }

    public XMLCodeGenMappingReader(DescriptionDictionary dictionary, Filer filer) {
