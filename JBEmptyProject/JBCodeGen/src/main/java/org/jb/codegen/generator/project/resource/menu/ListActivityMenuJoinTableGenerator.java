...
public class ListActivityMenuJoinTableGenerator extends EntityGenerator {
	AttributeDescription join;
	ClassDescription target;

	public ListActivityMenuJoinTableGenerator(ClassDescription c, AttributeDescription join, DescriptionDictionary dictionary) {
		super(c, dictionary);
		this.join = join;
	...
	public ListActivityMenuJoinTableGenerator(ClassDescription c, AttributeDescription join,
	...
	public void source() {
		...
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassContextMenuActionResourceName(c, join, Operation.LIST, dictionary, MenuAction.ADD) + "\"\n");
		str.append("			android:orderInCategory=\"100\"\n");
		str.append("			android:title=\"@string/" + activityResourceName.getClassContextMenuActionStringResourceName(MenuAction.ADD) + "\"\n");
		str.append("		/>\n");
		str.append("</menu>\n");
	}
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.menu", activityResourceName.getClassMenuResourceName(c, join, Operation.LIST, dictionary) + ".xml", element);
