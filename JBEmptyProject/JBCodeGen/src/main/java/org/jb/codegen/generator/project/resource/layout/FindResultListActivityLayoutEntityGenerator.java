...
public class FindResultListActivityLayoutEntityGenerator extends EntityGenerator {

	public FindResultListActivityLayoutEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
	...
	public void source() {
		...
		str.append("	<TextView\n");
		str.append("		android:id=\"@+id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\"\n");
		str.append("		android:layout_width=\"match_parent\"\n");
		...
		str.append("		android:text=\"@string/" + activityResourceName.getClassTitleStringResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\"\n");
		str.append("		android:textStyle=\"bold\"\n");
		str.append("		android:textAppearance=\"?android:attr/textAppearanceMedium\" />\n");
		
		str.append("	<View\n");
		str.append("		android:id=\"@+id/" + activityResourceName.getFragmentWidgetLineResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\"\n");
		str.append("		android:layout_width=\"match_parent\"\n");
		...
		str.append("		android:layout_below=\"@id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\" />\n");
		
		//TODO Transformar os Atributos em Fields
		str.append("	<fragment\n");
		str.append("		android:id=\"@+id/" + activityResourceName.getFragmentWidgetListResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\"\n");
		str.append("		android:name=\"app.jb.generated." + fragmentResourceName.getClassName(c, Operation.LIST, dictionary) + "\"\n");
		str.append("		android:layout_width=\"match_parent\"\n");
		str.append("		android:layout_height=\"match_parent\"\n");
		str.append("		android:orientation=\"vertical\"\n");
		str.append("		android:layout_below=\"@id/" + activityResourceName.getFragmentWidgetLineResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + "\">\n");
		str.append("	</fragment>\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.layout", activityResourceName.getClassLayoutResourceName(c, Operation.FIND_RESULT_LIST, dictionary) + ".xml", element);
