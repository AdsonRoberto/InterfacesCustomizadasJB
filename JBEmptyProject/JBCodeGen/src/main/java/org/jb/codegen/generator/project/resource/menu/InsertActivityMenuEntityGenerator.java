...
public class InsertActivityMenuEntityGenerator extends EntityGenerator {

	public InsertActivityMenuEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
	...
	public void source() {
		...
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassMenuActionResourceName(c, Operation.INSERT, dictionary, MenuAction.SAVE) + "\"\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.menu", activityResourceName.getClassMenuResourceName(c, Operation.INSERT, dictionary) + ".xml", element);
