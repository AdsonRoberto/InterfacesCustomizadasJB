...
public class ListActivityLayoutEntityGenerator extends EntityGenerator {

	public ListActivityLayoutEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
		// TODO Auto-generated constructor stub
	}

	public ListActivityLayoutEntityGenerator(ClassDescription c, DescriptionDictionary dictionary, Messager messager, Filer filer, Element element) {
	...
	public void source() {
		...
		str.append("	<TextView\n");
		str.append("		android:id=\"@+id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.LIST, dictionary) + "\"\n");
		str.append("		android:layout_width=\"match_parent\"\n");
		...
		str.append("		android:layout_below=\"@id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.LIST, dictionary) + "\" />\n");
		
		//TODO Transformar os Atributos em Fields
		str.append("	<fragment\n");
		str.append("		android:id=\"@+id/" + activityResourceName.getFragmentWidgetListResourceName(c, Operation.LIST, dictionary) + "\"\n");
		...
		str.append("		android:layout_below=\"@id/" + activityResourceName.getFragmentWidgetLineResourceName(c, Operation.LIST, dictionary) + "\">\n");
		str.append("	</fragment>\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.layout", activityResourceName.getClassLayoutResourceName(c, Operation.LIST, dictionary) + ".xml", element);
