...
public class DetailActivityLayoutEntityGenerator extends EntityGenerator {

	public DetailActivityLayoutEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
	...
	public void source() {
		...
		str.append("			<TextView\n");
		str.append("				android:id=\"@+id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.DETAIL, dictionary) + "\"\n");
		str.append("				android:layout_width=\"match_parent\"\n");
		...
		str.append("				android:text=\"@string/" + activityResourceName.getClassTitleStringResourceName(c, Operation.DETAIL, dictionary) + "\"\n");
		...
		str.append("				android:layout_height=\"match_parent\"\n");
		str.append("				android:orientation=\"vertical\"\n");
		str.append("				android:layout_below=\"@id/" + activityResourceName.getClassTitleWidgetResourceName(c, Operation.DETAIL, dictionary) + "\">\n");

		for (AttributeDescription attr : c.getAttributesForInterface(KindView.DETAIL)) {
			str.append("				" + activityResourceName.getDetailXMLWidget(attr, Operation.DETAIL, dictionary, 2));
		}
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT, "res.layout", activityResourceName.getClassLayoutResourceName(c, Operation.DETAIL, dictionary) + ".xml", element);
