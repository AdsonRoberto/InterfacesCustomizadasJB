...
public class XMLDescriptionProjectBuilder extends ProjectBuilder {
    public XMLDescriptionProjectBuilder(DescriptionDictionary dictionary) {
        super(dictionary);
    }

    public XMLDescriptionProjectBuilder(DescriptionDictionary dictionary, Messager messager, Filer filer, Element element) {
    ...
    public void buildEntityResourceFiles() {
        ...
        for(ClassDescription cd : dictionary.getClassValues()) {
            ...
            for(AttributeDescription ad : cd.getAttributesForInterface()) {
                if(ad.isCollection() &&
                        (ad.isAnnotatedWith(WebAggregation.class)
                                || ad.isXmlAnnotatedWith(XMLWebAggregation.class))) {
