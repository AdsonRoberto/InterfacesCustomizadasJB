...
public class ListActivityMenuEntityGenerator extends EntityGenerator {

	public ListActivityMenuEntityGenerator(ClassDescription c, DescriptionDictionary dictionary) {
		super(c, dictionary);
		// TODO Auto-generated constructor stub
	}

	public ListActivityMenuEntityGenerator(ClassDescription c,
	...
	public void source() {
		...
		if(!c.containsModifier("ABSTRACT")) {
			str.append("		<item\n");
			str.append("			android:id=\"@+id/" + activityResourceName.getClassMenuActionResourceName(c, Operation.LIST, dictionary, MenuAction.NEW) + "\"\n");
			str.append("			android:orderInCategory=\"100\"\n");
			str.append("			android:title=\"@string/" + activityResourceName.getClassMenuActionStringResourceName(MenuAction.NEW) + "\"\n");
			str.append("		/>\n");
		}
		str.append("		<item\n");
		str.append("			android:id=\"@+id/" + activityResourceName.getClassMenuActionResourceName(c, Operation.LIST, dictionary, MenuAction.FIND) + "\"\n");
		str.append("			android:orderInCategory=\"100\"\n");
	...
	public void generate() {
		...
		try {
			file = filer.createResource(StandardLocation.SOURCE_OUTPUT , "res.menu", activityResourceName.getClassMenuResourceName(c, Operation.LIST, dictionary) + ".xml", element);
